# -*- encoding: utf-8 -*-
# stub: strelka 0.12.0.pre20160411193737 ruby lib

Gem::Specification.new do |s|
  s.name = "strelka"
  s.version = "0.12.0.pre20160411193737"
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_runtime_dependency(%q<mongrel2>, ["~> 0.44"])
      ...
      s.add_dependency(%q<mongrel2>, ["~> 0.44"])
